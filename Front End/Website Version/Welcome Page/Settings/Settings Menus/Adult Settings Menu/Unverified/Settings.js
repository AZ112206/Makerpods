document.addEventListener("DOMContentLoaded", () => {
  ...
  if (verifyItem) {
    verifyItem.addEventListener("click", async () => {
      try {
                                const successUrl = 'http://localhost:3000/Front%20End/Website%20Version/Welcome%20Page/Settings/Settings%20Menus/Adult%20Settings%20Menu/Verified/Settings.html';
        const cancelUrl = 'http://localhost:3000/Front%20End/Website%20Version/Welcome%20Page/Settings/Settings%20Menus/Adult%20Settings%20Menu/Unverified/Settings.html';
